    ...
    return (
      ...
      >
        ...
        <p style={{ marginBottom: '20px' }}>
          <em>I write <a href="https://www.benjaminjohnson.me/blog/empathetic-code/" target="_blank">empathetic code</a> and build applications that people connect with directly. Regardless of the platform, solving difficult problems and building smooth user experiences is my jam.</em>
        </p>
        ...
        <div style={{ width: '100%' }}>
          ...
          {skills.map((skill) => (
            <span style={{ ...portfolioTypePillStyles }}>{skill}</span>
          ))}
        </div>
        ...
        <div style={{ display: 'flex' }}>
          <div style={{ width: '65%' }}>
            ...
            <ul style={{ marginTop: '10px', position: 'relative', left: '15px', width: 'calc(100% - 15px)' }}>
          ...
          <div style={{ width: '32%' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center' }}>
              <span className="mdi mdi-trophy-award" style={{ fontSize: '1.4rem', color: '#ababab', marginRight: '10px' }} />
            ...
            {/* ACADEMIC LISTS */}
            <div style={{ display: 'flex', alignItems: 'center' }}>
              <span className="mdi mdi-seal" style={{ fontSize: '1.4rem', color: '#ababab', marginRight: '10px' }} />
              <p style={{ marginBottom: '5px' }}>
                <span>
            ...
            {/* English */}
            <div style={{ display: 'flex', alignItems: 'center' }}>
              <span className="mdi mdi-message-text" style={{ fontSize: '1.4rem', color: '#ababab', marginRight: '10px' }} />
              <p style={{ marginBottom: '5px' }}>
                <span>
            ...
            {/* German */}
            <div style={{ display: 'flex', alignItems: 'center' }}>
              <span className="mdi mdi-message-bulleted" style={{ fontSize: '1.4rem', color: '#ababab', marginRight: '10px' }} />
              <p style={{ marginBottom: '5px' }}>
                <span>
            ...
            {/* Spanish */}
            <div style={{ display: 'flex', alignItems: 'center' }}>
              <span className="mdi mdi-message-processing" style={{ fontSize: '1.4rem', color: '#ababab', marginRight: '10px' }} />
              <p style={{ marginBottom: '5px' }}>
                <span>
            ...
            {/* GitHub */}
            <div style={{ display: 'flex', alignItems: 'center' }}>
              <span className="mdi mdi-github-circle" style={{ fontSize: '1.4rem', color: '#ababab', marginRight: '10px' }} />
              <p style={{ marginBottom: '5px' }}>
                <span>
            ...
            {/* Twitter */}
            <div style={{ display: 'flex', alignItems: 'center' }}>
              <span className="mdi mdi-twitter" style={{ fontSize: '1.4rem', color: '#ababab', marginRight: '10px' }} />
              <p style={{ marginBottom: '5px' }}>
                <span>
            ...
            {/* LinkedIn */}
            <div style={{ display: 'flex', alignItems: 'center' }}>
              <span className="mdi mdi-linkedin-box" style={{ fontSize: '1.4rem', color: '#ababab', marginRight: '10px' }} />
              <p style={{ marginBottom: '5px' }}>
                <span>
            ...
            {/* Soccer */}
            <div style={{ display: 'flex', alignItems: 'center' }}>
              <span className="mdi mdi-soccer" style={{ fontSize: '1.4rem', color: '#ababab', marginRight: '10px' }} />
              <p style={{ marginBottom: '5px' }}>
                <span>
            ...
            {/* Music */}
            <div style={{ display: 'flex', alignItems: 'center' }}>
              <span className="mdi mdi-airplane-takeoff" style={{ fontSize: '1.4rem', color: '#ababab', marginRight: '10px' }} />
              <p style={{ marginBottom: '5px' }}>
                <span>
