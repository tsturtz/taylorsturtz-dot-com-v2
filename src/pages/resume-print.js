...
class ResumePrint extends PureComponent {
  render() {
    return (
      <div
        id="resume"
      ...
      >
        ...
        <p style={{ marginBottom: '20px' }}>
          <em>I write empathetic code and build applications that people connect with directly. Regardless of the platform, solving difficult problems and building smooth user experiences is my jam.</em>
        </p>
        ...
        <div style={{ width: '100%' }}>
          ...
          {skills.map((skill) => (
            <span style={{ ...portfolioTypePillStylesPrint }}>{skill}</span>
          ))}
        </div>
